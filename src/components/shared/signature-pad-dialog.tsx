...
export function SignaturePadDialog({
  triggerLabel = "Ký điện tử",
  title = "Ký điện tử",
  description = "Vẽ chữ ký trực tiếp hoặc tải lên ảnh PNG/JPG.",
  onSave,
      ...
      <DialogContent className="sm:max-w-[500px]">
        ...
        <div className="space-y-4 py-4">
          <div className="flex gap-2">
            <Button variant={mode === "draw" ? "default" : "outline"} size="sm" onClick={() => setMode("draw")} className="flex-1">
            ...
            {mode === "draw" ? (
              <>
                <canvas
                  ...
                  onTouchMove={draw}
                />
                <Button variant="ghost" size="sm" className="absolute top-2 right-2 text-muted-foreground hover:text-foreground" onClick={clearCanvas}>
              ...
              <div className="flex flex-col items-center justify-center h-full">
                {imagePreview ? (
                  ...
                  <div className="text-center p-4">
                    ...
                    <input type="file" accept="image/*" onChange={handleFileUpload} className="mt-4 text-sm" />
                  </div>
                )}
              </div>
            )}
